package com.easydeliver.ink.app.base.ui.widget.bottombar;
...
public class BottomBar extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        LinearLayout ll_divider = new LinearLayout(context);
        ll_divider.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,1));
        ll_divider.setBackgroundColor(getResources().getColor(R.color.bge6e6e6));
        addView(ll_divider);
