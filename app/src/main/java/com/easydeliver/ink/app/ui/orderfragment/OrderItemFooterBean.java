...
public class OrderItemFooterBean {
    ...
    public OrderItemFooterBean() {
    }

    public OrderItemFooterBean(String url, String name, Integer count, String result, String fendian, Double price, Double yuanPrice, Double total, Double express_price) {
        Url = url;
        this.name = name;
        this.count = count;
        this.result = result;
