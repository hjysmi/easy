...
public class OrderItemProductBean  {
    private String Url;
    private String name;
    ...
    public OrderItemProductBean() {
    }

    public OrderItemProductBean(String url, String name, Integer count, String result, String fendian, Double price, Double yuanPrice, Double total, Double express_price) {
        Url = url;
        this.name = name;
        this.count = count;
        this.result = result;
